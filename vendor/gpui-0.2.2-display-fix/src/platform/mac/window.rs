...
// Keep the CAMetalLayer and GPUI viewport in sync even when macOS changes the
// window's screen without sending viewDidChangeBackingProperties (notably
// after disconnecting an external display). Backported from upstream GPUI
// commit 46eb9e5223036d103181c849187770917255eaac.
