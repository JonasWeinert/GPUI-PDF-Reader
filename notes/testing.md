...
- TOC coverage uses the fixture's nested four-entry outline. The backend test verifies titles, hierarchy, page destinations, and explicit coordinate presence; pure tests verify centered stack geometry, triangular hover falloff, breadcrumbs, and largest-title matching. The native Fluid scenario keeps a fully animated hover card open, resolves a page-only rotated-page entry by its heading text, and requires settled exact tiles there.
