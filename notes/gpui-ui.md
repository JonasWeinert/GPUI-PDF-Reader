...
- Fluid comment autosave should debounce editor changes, update the existing annotation ID so its highlight survives, and flush before starting the Back transition. Classic drafts remain explicit Save/Cancel operations.
